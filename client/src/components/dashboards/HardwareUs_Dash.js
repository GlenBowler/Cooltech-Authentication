...
//Coponent that will show us the Hardware user Dashboard
class HardwareUsDash extends React.Component {
constructor (props){
    super(props);
//Setting our states
this.state = {
...
componentDidMount () {
    //Fetching from routes. Geting all the users for user in the Hardware reviews unit
...
render () {
    ...
    //1: See all the user data in form of table
        ...
        return <div>
            ...
            <h2 className="titleDos">Hardware Reviews user Side</h2>
