...
//Coponent that will show us the News Manager Dashboard
...
componentDidMount () {
    //Fetching from routes. Geting all the users for manager in the News reviews unit
...
render () {
    ...
    //2: See all the user data in form of table
        ...
        return <div>
            ...
            <h2 className="titleDos">News Reviews Manager Side</h2>
        ...
        <div clasName="manager_container">
