...
//Coponent that will show us the Opinion Admin Dashboard
class HardwareAdDash extends React.Component {
constructor (props){
    super(props);
//Setting our states
this.state = {
...
componentDidMount () {
    //Fetching from routes. Geting all the users for admin in the Opinion reviews unit
    ...
    //3:Update the user role
     //4:See all the user data in form of table
        ...
        return <div>
            ...
            <h2 className="titleDos">Opinion Reviews Admin Side</h2>
        ...
        <div className="admin_container">
            ...
            <form action="/updateRole">
                ...
                <input type="text" placeholder="User Role" name="role" id="role" required/><br/><br/>            
                <button type="submit" className="button">Submit</button>
            </form>
        </div>
    </div>
