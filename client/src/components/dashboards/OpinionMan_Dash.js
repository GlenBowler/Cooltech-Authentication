...
//Coponent that will show us the Opinion Manager Dashboard
class OpinionManDash extends React.Component {
constructor (props){
    super(props);
//Setting our states
this.state = {
...
componentDidMount () {
    //Fetching from routes. Geting all the users for manager in the Opinion reviews unit
...
render () {
    ...
    //2: See all the user data in form of table
        ...
        return <div>
            ...
            <h2 className="titleDos">Opinion Reviews Manager Side</h2>
