...
//Coponent that will show us the Software Manager Dashboard
class SoftwareManDash extends React.Component {
constructor (props){
    super(props);
//Setting our states
this.state = {
...
componentDidMount () {
    //Fetching from routes. Geting all the users for manager in the Software reviews unit
...
render () {
    ...
    //2: See all the user data in form of table
        ...
        return <div>
            ...
            <h2 className="titleDos">Software Reviews Manager Side</h2>
        ...
        <div className="maanger_container">
...
//exporting component
export default SoftwareManDash;