...
//Coponent that will show us the Software User Dashboard
class SoftwareUsDash extends React.Component {
constructor (props){
    super(props);
//Setting our states
this.state = {
...
componentDidMount () {
    //Fetching from routes. Geting all the users for user in the Software reviews unit
...
render () {
    ...
    //1: See all the user data in form of table
        ...
        return <div>
            ...
            <h2 className="titleDos">Software Reviews User Side</h2>
